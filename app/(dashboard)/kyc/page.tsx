        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {FILTERS.map(({ value, label, icon: Icon, color, active }) => {
            ...
            return (
              ...
              >
                <div className={cn('rounded-xl p-2', isActive ? 'bg-white/60' : 'bg-slate-50')}>
                  <Icon className={cn('h-4 w-4', isActive ? '' : color)} />
                </div>
                <div>
                  <p className="text-[11px] font-medium uppercase tracking-wider text-current opacity-60">{label}</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/50">
                    ...
                    <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-slate-400 hidden lg:table-cell">Inscrit le</th>
                    <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-slate-400">Statut KYC</th>
                    <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-slate-400">Compte</th>
